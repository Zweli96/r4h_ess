        ...
        >
            ...
            <TableRow>
              ...
              {daysChunk.map((d) => (
                <TableCell
                  key={d.dateStr}
                  align="center"
                  sx={{ minWidth: "80px", border: "1px solid black" }}
                >
                  {d.dayName}
                </TableCell>
              ))}
          ...
          <TableBody>
            {chunkRows.map((row, rowIndex) => {
              ...
              const loe =
                LOE_ACTIVITIES.includes(row.activity) && chunkTotal > 0
                  ? (rowTotal / chunkTotal) * 100
                  : 0;
              ...
              return (
                <TableRow key={row.activity}>
                  ...
                  <TableCell
                    align="center"
                    sx={{ minWidth: "100px", border: "1px solid black" }}
                  >
                    <TextField
                      type="text"
                      size="small"
                      value={row.charge}
                      onChange={(e) =>
                        handleChargeChange(chunkIndex, rowIndex, e.target.value)
                      }
                      sx={{
                        width: "100px",
                        border: "none",
            ...
            <TableRow>
              ...
              <TableCell
                align="center"
                sx={{ border: "1px solid black", minWidth: "80px" }}
              >
                {chunkTotal > 0
                  ? `${calcChunkLOE(chunkRows, chunkTotal).toFixed(2)}%`
                  : "0%"}
              </TableCell>
              <TableCell
                align="center"
