    ...
    const chunkDaysByWeek = (days, chunkSize) => {
      ...
      for (const date of days) {
        ...
        chunk.push({
          ...
          dayName: new Date(date).toLocaleString("default", {
            weekday: "short",
          }),
...
/> */}
          <img src="/r4hlogo.png" alt="R4H LOGO" className="print-logo" />
          ...
          >
            <div>
              ...
              >
                {viewedTimesheet.created_by_full_name} -{" "}
                {formatDateTime(viewedTimesheet.created_at)}{" "}
              </span>
            </div>
            <div>
              ...
              >
                {viewedTimesheet.line_manager_full_name} -{" "}
                {formatDateTime(viewedTimesheet.first_approval_date)}
              </span>
            </div>
            <div>
              ...
              >
                {viewedTimesheet.second_approver_full_name} -{" "}
                {formatDateTime(viewedTimesheet.second_approval_date)}
              </span>
            </div>
          </div>
        </div>
      ...
      {chunkedDays.length === 0 ? (
        <div style={{ textAlign: "center", fontSize: 18 }}>Loading data...</div>
      ) : (
      ...
      {viewedTimesheet && (
        <div>
          <span style={{ fontWeight: "bolder" }}>Grand total Hours</span> :{" "}
          <span style={{ borderBottom: "2px solid black" }}>
            {viewedTimesheet.total_hours} hrs
          </span>{" "}
        </div>
      )}
    </div>
